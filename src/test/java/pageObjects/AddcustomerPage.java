...
public class AddcustomerPage {
	...
	By txtcustomerRoles = By.xpath("//*[@id=\"customer-info\"]/div[2]/div[10]/div[2]/div/div[1]/div");
	By txtcustomerRolesUnselect = By.xpath("//*[@id=\"SelectedCustomerRoleIds_taglist\"]/li/span[2]");
	

//	By lstitemAdministrators = By.xpath("//li[contains(text(),'Administrators')]");
//	By lstitemRegistered = By.xpath("//li[contains(text(),'Registered')]");
//	By lstitemGuests = By.xpath("//li[contains(text(),'Guests')]");
//	By lstitemVendors = By.xpath("//li[contains(test(),'Vendors')]");
	
	By lstitemAdministrators = By.xpath("//*[@id=\"SelectedCustomerRoleIds_listbox\"]/li[1]");
	By lstitemRegistered = By.xpath("//*[@id=\"dcb35b9c-0d40-4639-bbc9-764b4d832813\"]");
	...
	public void setCustomerRoles(String role) throws InterruptedException {
		...
		ldriver.findElement(txtcustomerRolesUnselect).click();
